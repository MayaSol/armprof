...
$(function () {
  ...
  */
  ...
  $('.style-select select').styler(); // jwplayer("video-player").onComplete(function(){
  //  vtl.show();
  //  vpl.hide();
  // })
...
$('.add-to-cart').live('click', function () {
  ...
  if ($(this).closest('.category-item').length > 0) {
    var desc = $(this).closest('.category-item').find('.ct-name').html();
  } else {
    var desc = $(this).closest('.produkt-wrp').find('div[itemprop="name"]').html();
  }

  console.log('desc = ' + desc); // var showAlertProxy = function showAlertProxy() {
  //   console.log('showAlertProxy');
  //   console.log(btnAdd);
  //   var desc = '';
  //   if ($(btnAdd).closest('.category-item').length > 0) {
  //     var desc = $(btnAdd).closest('.category-item').find('.ct-name').html();
  //   }
  //   else {
  //     var desc = $(btnAdd).closest('.produkt-wrp').find('div[itemprop="name"]').html();
  //   }
  //   console.log(desc);
